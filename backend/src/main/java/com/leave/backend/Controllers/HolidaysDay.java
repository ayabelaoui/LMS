...
public class HolidaysDay {
    ...
    // // @Value("${api.key}") // Injection de la clé API depuis les propriétés de
    // l'application
    ...
    // String url =
    // "https://anyapi.io/api/v1/holidays?country=MA&language=fr&apiKey=p9912krcon0brd4nobt804d19plv2h82ec2al9bmt6sjt0iqbq5o";
    ...
    // "p9912krcon0brd4nobt804d19plv2h82ec2al9bmt6sjt0iqbq5o");
    // HttpEntity<String> entity = new HttpEntity<>(headers);
    // Object[] holidays = restTemplate.exchange(url, HttpMethod.GET, entity,
